...
typedef hash_map<char*, MatchSet_t, __gnu_cxx::hash<char *>, StrCmp_t> MatchSetMap_t;
...
typedef hash_map<char *, Seq_t, __gnu_cxx::hash<char *>, StrCmp_t> SeqMap_t;
typedef hash_set<const char *, __gnu_cxx::hash<const char *>, StrCmp_t> SeqSet_t;
...
typedef hash_map<char*, SeqCover_t, __gnu_cxx::hash<char*>, StrCmp_t> SeqCoverMap_t;
typedef hash_map<char*, SeqCoverSet_t, __gnu_cxx::hash<char*>, StrCmp_t> SeqCoverSetMap_t;

typedef hash_map<char*, SeqCoverMap_t, __gnu_cxx::hash<char*>, StrCmp_t> TaxMap_t;
typedef hash_map<char*, SeqCoverSetMap_t, __gnu_cxx::hash<char*>, StrCmp_t> TaxSetMap_t;
